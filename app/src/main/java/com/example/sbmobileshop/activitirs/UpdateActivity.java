...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateTitle, updatePrice,updateQty;
    String title, desc;
    String qty;
    String price;
    String imageUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateDesc = findViewById(R.id.productDescription);
        updateImage = findViewById(R.id.uploadImage);
        updatePrice = findViewById(R.id.uploadprice);
        updateTitle = findViewById(R.id.uploadTopic);
        updateQty = findViewById(R.id.uploadqty);
        ...
        if (bundle != null){
            ...
            updateQty.setText(bundle.getString("Qty"));
    ...
    public void updateData(){
        ...
        qty = updateQty.getText().toString();
        DataClass dataClass = new DataClass(title, desc,qty,price, imageUrl);
