...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTopic, uploadDesc, uploadPrice,uploadQty;
    String imageURL;
    Uri uri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadDesc = findViewById(R.id.productDescription);
        uploadTopic = findViewById(R.id.uploadTopic);
        uploadPrice = findViewById(R.id.price);
        uploadQty = findViewById(R.id.qty);
    ...
    public void uploadData(){
        ...
        String qty = uploadQty.getText().toString();
